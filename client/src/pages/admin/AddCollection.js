...
// import success, { getStatusStyles, getStockStatusStyles } from "../../utils/index.js";
...
//       console.log("updatedFilterDivStates ", updatedFilterDivStates);
...
//         console.log("filteredConditionValues ", filteredConditionValues);
...
//       return { ...prevFormData, filterDivStates: updatedStates };
//     });
//     console.log("formData in handleConditionValueChange", formData);
//   };
...
//     console.log("Data to send in backend ", changedTitleFilterArr);
...
//         console.log("Response data of filterd  ", response?.data);
//       }
//     } catch (error) {
...
//   const data = useMemo(() => {
//     console.log(
//       "collectionProductTableList in data  ",
...
//     );
//     console.log("extractedConditionNames ", extractedConditionNames);
//     let extractedConditionValue = formData.filterDivStates.map(
//       (item) => item.conditionValue
//     );
//     console.log("extractedConditionValue ", extractedConditionValue);
