...
function AddSubMenus() {
  ...
  const createSubMenu = async (e) => {
    ...
    try {
      const response = await API_WRAPPER.post("/sub-menu/create", dataToSend);
      success("Success", "Sub menu created successfully!");
